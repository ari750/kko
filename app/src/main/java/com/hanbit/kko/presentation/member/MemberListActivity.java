...
import com.hanbit.kko.util.MemberAdaptor;
...
public class MemberListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Service에서 리턴한 데이타 갯수:",String.valueOf(list.size()));
        lv_member_list.setAdapter(new MemberAdaptor(list,this));
        ...
        lv_member_list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View v, int i, long l) {
                ...
                new AlertDialog.Builder(MemberListActivity.this)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() { //Ctrl + space
                            @Override
